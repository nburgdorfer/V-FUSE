...
class DTU(BaseDataset):
    ...
    def get_cluster_list_file(self, scene):
        return os.path.join(self.cfg["data_path"], "Cameras/pair.txt")        
    ...
    def samples_from_cluster_list(self):
        ...
        for scene in self.scenes:
            ...
            cluster_list = load_cluster_list(os.path.join(self.data_path, f"Cameras/pair.txt"))

            cam_folder = os.path.join(self.data_path, f"Cameras")
